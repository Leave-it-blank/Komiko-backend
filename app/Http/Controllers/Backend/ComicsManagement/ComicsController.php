...
class ComicsController extends Controller
{
    ...
    public function storeComic(Request $request)
    {
        ...
        $comic =  $this->validate($request, [
            ...
            'thumb' => 'mimes:jpg,png,jpeg,gif,webp|required|dimensions:min_width=490,min_height=690, max_width=550,max_height=750',
            'author' => 'int|required',
            'artist' => 'int|required',
        ...
        try {
            ...
            $media = $Tcomic->addMediaFromDisk($thumbnail_url)
                //->withResponsiveImages() //not required tbh
    ...
    public function editStoreComic(Comic $comic, Request $request)
    {
        ...
        $valcomic =  $this->validate($request, [
            ...
            'isLocked' => 'bool|required',
            'isMature' => 'bool|required',
            'thumb' => 'mimes:jpg,png,jpeg,gif,webp|dimensions:min_width=490,min_height=690, max_width=550,max_height=750|nullable',
            'author' => 'int|required',
            'artist' => 'int|required',
            'publisher' => 'int|required',
            'country' => 'int|required',
