        ...
        >
          <div class="flex justify-between">
            ...
            <div class="mx-1 my-2">
              <BaseButton
                label="Go Back"
                routeName="comics_management.comics"
                color="info"
              />
            </div>
          </div>
          <form @submit.prevent="submit" enctype="multipart/form-data">
            <div
              class="p-1 mt-5 bg-white rounded-md border shadow-sm md:p-5 dark:bg-gray-900/70 border-light"
            >
              ...
              <div class="grid grid-cols-8 gap-3 my-4">
                <div class="col-span-8 sm:col-span-4 xl:col-span-2">
                  <label
                    class="block text-sm font-medium text-primary-dark dark:text-primary-light"
                    >Visibility</label
                  >
                  <select
              ...
              <div class="grid grid-cols-8 gap-3 my-4">
                <div class="col-span-8 sm:col-span-4 xl:col-span-2">
                  ...
                  <select
                    ...
                    class="block px-3 py-2 mt-1 mr-3 w-full bg-transparent rounded-md border shadow-sm dark:text-gray-400 border-primary-dark dark:border-primary-light focus:outline-none focus:ring-primary-lighter focus:border-primary-lighter sm:text-sm"
                  >
                    <option v-for="author in props.authors" :value="author.id">
                      {{ author.name }}
                    </option>
                  </select>
                ...
                <div class="col-span-8 sm:col-span-4 xl:col-span-2">
                  ...
                  <select
                    ...
                    class="block px-3 py-2 mt-1 mr-3 w-full bg-transparent rounded-md border shadow-sm dark:text-gray-400 border-primary-dark dark:border-primary-light focus:outline-none focus:ring-primary-lighter focus:border-primary-lighter sm:text-sm"
                  >
                    <option v-for="artist in props.artists" :value="artist.id">
                      {{ artist.name }}
                    </option>
                  </select>
                ...
                <div>
                  <div class="grid grid-cols-2">
                    <div class="col-span-2 p-2 m-2 md:p-4 md:col-span-1">
                      <div
                        class="font-medium capitalize text-md text-primary-dark dark:text-primary-light"
                      >
                        Thumbnail
                      </div>
                    ...
                    >
                      <div
                        class="mx-1 text-primary-dark dark:text-primary-light"
                      >
