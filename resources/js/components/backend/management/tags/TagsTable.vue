...
<template>
  ...
  <DeleteItemsModal
    ...
    title="Do you really wanna delete the Tag?"
    button="danger"
    buttonLabel="Delete"
    hasCancel
    itemName="tag"
    :itemId="dataChapter"
  >
    You are About to delete Tag number {{ dataChapter }} permanently. Warning:
  ...
  <table>
    ...
    <tbody>
      ...
      >
        ...
        <td data-label="Tag Code">
          {{ client.tagCode }}
        </td>

        <td data-label="Svg">
          <small class="text-gray-500 dark:text-gray-400" :title="client.svg">{{
            client.svg
          }}</small>
        </td>
