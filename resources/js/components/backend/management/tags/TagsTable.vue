...
<template>
  ...
  <div class="mb-3 xl:w-96">
   <SearchTable :searchArray="prop.tags" Search  searchIndexName='name'  :searchComic="true" />
  </div>
  ...
  <DeleteItemsModal
    ...
    :itemId="dataChapter"
  >
     You are About to delete Tag number {{dataChapter}} permanently.
