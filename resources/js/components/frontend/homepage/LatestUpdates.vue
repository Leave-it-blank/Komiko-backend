                ...
                <div class="flex flex-col font-roboto py-4 px-4 md:px-1 text-zinc-600">
                  <Link :href="comic.viewUrl">
                    <div class="h-5 w-full">
                      <div
                        class="text-md mb-2 text-left select-none cursor-pointer text-zinc-900 flex-none pb-2 dark:text-white flex-0 truncate w-44 hover:text-purple-400 dark:hover:text-purple-500 font-bold"
                      >
                        {{ comic.title }}
                      </div>
                    </div>
