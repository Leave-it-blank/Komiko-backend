              ...
              <Link :href="comic.cviewUrl">
                <div class="relative backdrop:bg-yellow-400">
                  ...
                  <div class="absolute bottom-0 left-0 right-0 px-4 py-2 flex justify-start md:justify-center">
                    <div
                      class=" shrink-1 py-1 opacity-80 text-lg md:text-sm font-semibold mt-2 font-roboto capitalize  text-purple-500 text-center select-none cursor-pointer     border-purple-500  border-2 bg-white rounded-md w-fit px-3"
                    >
